...
export default memo(function App() {
  ...
  return (
  <div style={{width:'1120px',margin:'11px auto'}}>
    <div><strong style={{fontSize:'22px'}}>Tag:</strong><input/></div>
    <Table columns={columns} dataSource={datas} bordered='true' scroll={{ y: '520px' }} pagination={false}/>
  </div>
  );
});
